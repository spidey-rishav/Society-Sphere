  ...
  return (
    <div className='flex items-center justify-between px-8 py-4 bg-[#0b2d35] text-[#ffffff]'>
      ...
      <button
        ...
        className='bg-gradient-to-r cursor-pointer from-[#5b42e4] via-[#8137e9] to-[#7f32da] h-15 flex items-center gap-2 hover:bg-blue-700 hover:scale-110 transition duration-300 ease-in-out text-white py-2 px-4 rounded-4xl'>
